...
RUN apt-get update && apt-get install -y build-essential git ruby ruby-nokogiri gettext file wget cpio bc libncurses5-dev libncursesw5-dev genext2fs mtd-utils squashfs-tools u-boot-tools util-linux patchelf bison cmake flex gettext m4 xz-utils vim rsync python3
